  ...
  return (
    <div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="/store/add_med" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Medicine</a>
                    </div>
                </div>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="/store/delete_med/<%= list[i].id%>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                            {/* <% } %> */}
        ...
        <div id="delete_asset" class="modal fade delete-modal" role="dialog">
            {/* <% for (var i = 0; i < list.length; i++){ %> */}
            {/* action="/store/delete_med/<%= list[i].id%>" method="POST" */}
                <form >
                    {/* <% } %> */}
